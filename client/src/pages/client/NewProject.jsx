...
const NewProject = () => {
    ...
    const handleSubmit = async() =>{
      await axios.post("https://freelance-application-zerd.onrender.com/new-project", {title, description, budget, skills, clientId: localStorage.getItem('userId'),  clientName: localStorage.getItem('username'),  clientEmail: localStorage.getItem('email')}).then(
        (response)=>{
