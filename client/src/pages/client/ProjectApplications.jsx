...
const ProjectApplications = () => {
  ...
  const handleApprove = async(id)=>{
    await axios.get(`https://freelance-application-zerd.onrender.com/approve-application/${id}`).then(
      (response)=>{
  ...
  const handleReject = async(id)=>{
    await axios.get(`https://freelance-application-zerd.onrender.com/reject-application/${id}`).then(
      (response)=>{
