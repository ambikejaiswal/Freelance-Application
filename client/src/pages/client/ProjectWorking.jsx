...
const ProjectWorking = () => {
  ...
  const handleApproveSubmission = async() =>{
    await axios.get(`https://freelance-application-zerd.onrender.com/approve-submission/${params['id']}`).then(
      (response)=>{
        fetchProject(params['id']);
  ...
  const handleRejectSubmission = async() =>{
    await axios.get(`https://freelance-application-zerd.onrender.com/reject-submission/${params['id']}`).then(
      (response)=>{
        fetchProject(params['id']);
