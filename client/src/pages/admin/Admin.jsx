...
const Admin = () => {
  ...
  const fetchProjects = async() =>{
      await axios.get("https://freelance-application-zerd.onrender.com/fetch-projects").then(
        (response)=>{
...
const fetchUsers = async() =>{
  await axios.get("https://freelance-application-zerd.onrender.com/fetch-users").then(
    (response)=>{
