...
const Freelancer = () => {
  ...
  const fetchUserData = async(id) =>{
      axios.get(`https://freelance-application-zerd.onrender.com/fetch-freelancer/${id}`).then(
        (response)=>{
  ...
  const updateUserData = async() =>{
    axios.post(`https://freelance-application-zerd.onrender.com/update-freelancer`, {freelancerId, updateSkills: updateSkills, description: updateDescription}).then(
        (response)=>{
          fetchUserData();
  ...
  const fetchApplications = async() =>{
    await axios.get("https://freelance-application-zerd.onrender.com/fetch-applications").then(
      (response)=>{
