...
const ProjectData = () => {
  ...
  const fetchProject = async(id) =>{
    await axios.get(`https://freelance-application-zerd.onrender.com/fetch-project/${id}`).then(
      (response)=>{
    ...
    const handleBidding = async() =>{
      ...
      await axios.post("https://freelance-application-zerd.onrender.com/make-bid", {clientId, freelancerId, projectId, proposal, bidAmount, estimatedTime}).then(
        (response)=>{
            setProposal('');
            setBidAmount(0);
            setEstimatedTime(0);
    ...
    const handleProjectSubmission = async() =>{
      ...
      await axios.post("https://freelance-application-zerd.onrender.com/submit-project", {clientId, freelancerId, projectId, projectLink, manualLink, submissionDescription}).then(
        (response)=>{
            setProjectLink('');
            setManualLink('');
    ...
    const fetchChats = async() =>{
      await axios.get(`https://freelance-application-zerd.onrender.com/fetch-chats/${params['id']}`).then(
        (response) =>{
