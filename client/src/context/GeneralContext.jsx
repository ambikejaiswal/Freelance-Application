...
//   const WS = 'https://freelance-application-zerd.onrender.com';
...
//         await axios.post('https://freelance-application-zerd.onrender.com/login', loginInputs)
//         .then( async (res)=>{
...
//     try{
//         await axios.post('https://freelance-application-zerd.onrender.com/register', inputs)
//         .then( async (res)=>{
//             localStorage.setItem('userId', res.data._id);
//             localStorage.setItem('usertype', res.data.usertype);
//             localStorage.setItem('username', res.data.username);
...
const GeneralContextProvider = ({ children }) => {
  ...
  const login = async () => {
    try {
      ...
      await axios.post(
        'https://freelance-application-zerd.onrender.com/login',
        loginInputs
      )
      .then(async (res) => {
  ...
  const register = async () => {
    try {
      await axios.post(
        'https://freelance-application-zerd.onrender.com/register',
        inputs
      )
      .then(async (res) => {
